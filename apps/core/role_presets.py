...
ROLE_GROUP_PRESETS = {
    ...
    'ISP Cashier': {
        'permissions': [
            ...
            ('accounting', 'view_apvendor'),
            ('accounting', 'view_apvendorbill'),
            ('accounting', 'view_apvendorbillattachment'),
            ('accounting', 'view_apvendorpayment'),
            ('accounting', 'view_chartofaccount'),
            ('accounting', 'view_cashreconciliationexception'),
            ('accounting', 'view_cashreconciliationmatch'),
            ('accounting', 'view_cashstatementimport'),
            ('accounting', 'view_cashstatementline'),
            ...
            ('accounting', 'view_openingbalanceimport'),
            ('accounting', 'view_openingbalanceline'),
            ('accounting', 'view_customerwithholdingallocation'),
            ('accounting', 'view_customerwithholdingtaxclaim'),
            ('accounting', 'view_withholdingtaxclass'),
            ('sms', 'view_smslog'),
        ],
    },
    'ISP Support': {
