...
urlpatterns = [
    ...
    path('operations/', views.nms_operations, name='nms-operations'),
    path('analytics/', views.nms_analytics, name='nms-analytics'),
    ...
    path('api/attachments/<int:attachment_pk>/geometry/', views.nms_update_attachment_geometry_api, name='nms-update-attachment-geometry-api'),
    path('links/', views.nms_links, name='nms-links'),
    path('links/<int:link_pk>/delete/', views.nms_delete_link, name='nms-delete-link'),
    path('nodes/<int:node_pk>/delete/', views.nms_delete_node, name='nms-delete-node'),
