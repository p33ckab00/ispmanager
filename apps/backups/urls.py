...
urlpatterns = [
    ...
    path('<int:pk>/production-restore/plan/create/', views.create_production_restore_plan_view, name='backups-create-production-restore-plan'),
    path('production-restore/plans/<int:pk>/', views.production_restore_plan_view, name='backups-production-restore-plan'),
